...
```sh
git clone https://github.com/Splatform2000/splatformfrontend.git
git clone https://github.com/Splatform2000/splatformbackend.git
...
```sh
MONGO_URL = "mongodb+srv://splatform:Splatform2000@splatform.rohck.mongodb.net/?retryWrites=true&w=majority&appName=Splatform"

#mongo_url present in (backend index.js file)
```
...
npm start
```
Now, navigate to `https://sahasrahighschool.vercel.app/` in your browser. 
The Backend API will be running at `https://splatformbackend.onrender.com`.
<br>
# Error Solution
...
```javascript
const REACT_APP_BASE_URL ="https://splatformbackend.onrender.com" ;
```
